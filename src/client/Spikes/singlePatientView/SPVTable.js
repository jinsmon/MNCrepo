...
export default class SPVTable extends ControlBase {
    ...
    childRender() {
        ...
        for (let i = 0; i < visits.length; i++) {
            ...
            summary = <Image className="img-responsive center-block " src="./patient/summary_icon.png" />;
            view = <Image className="img-responsive center-block" src="./patient/view_icon.png" />;
            contents.push(
                <tr>
    				 	<td>{status}</td>
    				 	<td>{type}</td>
