...
import MoGridBody from './MoGridBody';
...
var WorklistView = React.createClass({
    ...
    render: function() {
        ...
        var nameStyle = {width: '140px'};

        var spNameStyle = {width: '140px'};
        var ageStyle = {width: '60px'};
        var phoneStyle = {width: '125px'};
        var pregStatusStyle = {width: '175px'};
        var obstStyle = {width: '100px'};
        var riskStyle = {width: '70px'};
        var nextVisitDateStyle = {width: '97px'};

        var subCenterNumberStyle = {width: '127px'};

        var subCenterNameStyle = {width: '150px'};

        var vhnNameStyle = {width: '100px'};
        ...
        var styles = {
            ...
            subCentreNumber: subCenterNumberStyle,
            subCentreName: subCenterNameStyle,
            vhnName: vhnNameStyle,
        ...
        return (
            ...
            <section className="content-header breadcrumb" style={contentHeader}>
                 ...
                 <div className="box-header" style={headerDivStyle}>
                   <div className="pull-left"> <h3 className="box-title" style={h3Top}>Physician Worklist</h3></div>
                    ...
                    <div  className="dataTables_wrapper form-inline dt-bootstrap">
                      <div className="row" style={clearMargin}>
                          <DataGrid headerJson={headerJson} >
                              <MoGridBody tableContents={formatedData} {...this.props} />
                          </DataGrid>
                       </div>
                       <div className="row" style={clearMargin}>
